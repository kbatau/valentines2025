          ...
          >
            {isEnvelopeVisible ? (
                    ...
                    <div 
                      ...
                      <img className="w-full h-full object-contain" src="images/stamp.png" alt="Heart Stamp"/>
                    </div>
                      ...
                      className="flex flex-col items-center justify-center gap-8 p-8">
                        <div className="bg-white p-4 rounded-lg shadow-lg w-fit rotate-355">
                          <div className="md:w-64 md:h-64 w-32 h-32 mb-4">
                            <img className="w-full h-full object-cover rounded" src="images/line-heart.gif"/>
                          </div>
